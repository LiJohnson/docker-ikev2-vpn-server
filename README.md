...
### 1. Start the IKEv2 VPN Server
    ...
    docker run --privileged -d --name ikev2-vpn-server --restart=always -p 500:500/udp -p 4500:4500/udp lijohnson/ubuntu:ikev2
...
*`[ -e "IP=10.8.0.3"]` is option, and run has to run `docker exec ikev2-vpn-server /usr/sbin/ipsec reload`*
